$(document).ready(function(){
    ...
    // 휠을 사용할때 delta를 사용하다....그냥 정의된 녀석..
// 마우스휠을 했을때 스크롤의 위치를 바꾸어라.
    let mo =0
...
$('article').mousemove(function(e){
    ...
    let x=e.pageX/100;
    // 펑션에 있는 e와 변수 e는 명칭을 갖게해줘야한다.function(envent), 
    let y=e.pageY/100;
